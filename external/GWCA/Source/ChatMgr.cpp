        ...
        if (sender_encoded) {
            ...
            if (has_markup) {
                ...
                if (has_link_in_message) {
                    format =
                        static_cast<wchar_t[]>(L"\x108\x107<a=2>\x1\x2%s\x2\x108\x107</a>\x1\x2\x108\x107: \x1\x2%s");
                }
                else {
                    format =
                        static_cast<wchar_t[]>(L"\x108\x107<a=1>\x1\x2%s\x2\x108\x107</a>\x1\x2\x108\x107: \x1\x2%s");
                }
                len += 19;
            }
