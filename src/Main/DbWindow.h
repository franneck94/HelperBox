...
private:
    ...
    uint32_t move_idx = 0;
    std::array<Move, 27> moves = {
        Move{613.38F, 7097.03F, "SQ", MoveState::DONT_WAIT, [&]() { skillbar.sq.Cast(player.energy); }},
        Move{358.88F, 7503.61F, "Move EoE", MoveState::DONT_WAIT},
        Move{358.88F, 7503.61F, "EoE", MoveState::CAST_SKILL, &skillbar.eoe},
        Move{1319.41F, 7299.941F, "Move Qz", MoveState::DONT_WAIT},
        Move{1319.41F, 7299.94F, "Qz", MoveState::CAST_SKILL, &skillbar.qz},
        Move{985.70F, 7325.54F, "Move Stairs", MoveState::WAIT, 1400.0F},
        Move{-583.28F, 9275.68F, "Lab Stairs1", MoveState::WAIT, 1400.0F},
        Move{-1726.89F, 10689.08F, "Lab Stairs2", MoveState::WAIT, 1400.0F},
        Move{-2984.86F, 10410.74F, "Lab Stairs3", MoveState::WAIT, 1400.0F},
        Move{-4100.17F, 11299.99F, "Lab Stairs4", MoveState::CAST_SKILL, &skillbar.eoe},
        Move{-5751.45F, 12746.52F, "Lab Reaper", MoveState::DONT_WAIT, [&]() { TargetClosestReaper(player); }},
        Move{-5751.45F, 12746.52F, "Restore", MoveState::DONT_WAIT, [&]() { TakeRestore(); }},
        Move{-5751.45F, 12746.52F, "Escort", MoveState::DONT_WAIT, [&]() { TakeEscort(); }},
        Move{-6445.15F, 10392.83F, "Fuse Pull 1", MoveState::CAST_SKILL, &skillbar.eoe},
        Move{-6241.24F, 7945.73F, "Basement", MoveState::WAIT, 2000.0F},
        Move{-8763.36F, 5551.18F, "Basement Stairs", MoveState::WAIT, 2000.0F},
        Move{-7829.98F, 4324.09F, "Fuse Pull 2", MoveState::CAST_SKILL, &skillbar.eoe},
