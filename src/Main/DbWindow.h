...
private:
    ...
    std::array<Move, 56> moves = {
        ...
        Move{8685.21F, 6344.59F, "Pits Take", MoveState::NO_WAIT_AND_CONTINUE, [&]() { TakePits(); }},
        ...
        Move{11368.55F, -17974.64F, "Planes Take", MoveState::NO_WAIT_AND_CONTINUE, [&]() { TakePlanes(); }},
