...
private:
    ...
    std::array<Move, 52> moves = {
        ...
        Move{-5246.27F, 11386.62F, "Lab 5", MoveState::WAIT},
        Move{-5751.45F, 12746.52F, "Lab Reaper", MoveState::LT_DISTANCE, [&]() { TargetClosestReaper(player); }},
        Move{-6263.33F, 9899.79F, "Fuse 1", MoveState::STOP, [&]() { ToLowArmor(bag_idx, start_slot_idx); }},
        ...
        Move{-7829.98F, 4324.09F, "Fuse 2", MoveState::STOP},
        ...
        Move{-13872.34F, 2332.34F, "Spirits 1", MoveState::STOP},
        Move{-13760.19F, 358.15F, "Spirits 2", MoveState::STOP},
        Move{-12145.44F, 1101.74F, "Vale Center", MoveState::DONT_WAIT},
        ...
        Move{-6035.29F, 11285.14F, "Keeper 1", MoveState::STOP},
        Move{-6511.41F, 12447.65F, "Keeper 2", MoveState::STOP},
        Move{-3881.71F, 11280.04F, "Keeper 3", MoveState::STOP},
        Move{-1502.45F, 9737.64F, "Keeper 4/5", MoveState::STOP},
        Move{-266.03F, 9304.26F, "Lab 1", MoveState::DONT_WAIT},
        Move{1207.05F, 7732.16F, "Keeper 6", MoveState::STOP},
        ...
        Move{6633.37F, 15385.31F, "Wastes 1", MoveState::STOP},
        Move{6054.83F, 18997.46F, "Wastes 2", MoveState::STOP},
        Move{4968.64F, 16555.77F, "Wastes 3", MoveState::WAIT},
        Move{2152.55F, 16893.93F, "Wastes 4", MoveState::STOP},
        Move{12566.49F, 7812.503F, "Pits 1", MoveState::DONT_WAIT},
        Move{11958.36F, 6281.43F, "Pits 2", MoveState::STOP},
        Move{12160.99F, -16830.55F, "Planes 1", MoveState::STOP},
