...
private:
    ...
    std::array<Move, 52> moves = {
        ...
        Move{-6263.33F, 9899.79F, "Fuse 1", MoveState::WAIT_AND_CONTINUE, swap_to_low_armor_fn},
        ...
        Move{-12145.44F, 1101.74F, "Vale Center", MoveState::NO_WAIT_AND_CONTINUE},
        ...
        Move{8389.26F, 12009.86F, "To Wastes 6", MoveState::NO_WAIT_AND_CONTINUE},
        Move{6633.37F, 15385.31F, "Wastes 1", MoveState::NO_WAIT_AND_CONTINUE},
