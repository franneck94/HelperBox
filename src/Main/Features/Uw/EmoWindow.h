...
private:
    ...
    std::array<MoveABC *, 55> moves = {
        ...
        new Move_WaitAndContinue{-5751.45F, 12746.52F, "Go Lab Reaper", target_reaper_fn},
        new Move_DistanceAndContinue{-5830.34F, 11781.70F, "Go Lab 6", 3700.0F},
        ...
        new Move_NoWaitAndContinue{6599.55F, 11016.60F, "Go To Wastes 5"},
        ...
        new Move_NoWaitAndStop{-16105.50F, 17284.84F, "Go To Dhuum 6"},
    };
};
