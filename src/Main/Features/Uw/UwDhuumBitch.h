...
private:
    ...
    uint32_t move_idx = 0;
    const std::array<MoveABC *, 62> moves = {
        new Move_WaitAndStop{1248.00F, 6965.51F, "Go Spawn"},
        ...
        new Move_WaitAndContinue{1319.41F, 7299.941F, "Go Qz"},
        new Move_WaitAndContinue{985.70F, 7325.54F, "Go Chamber 1"},
        new Move_WaitAndContinue{-634.07F, 9071.42F, "Go Chamber 2"}, // 10
        ...
        new Move_NoWaitAndContinue{-5751.45F, 12746.52F, "Talk Lab", talk_reaper_fn},
        new Move_NoWaitAndContinue{-5751.45F, 12746.52F, "Accept Lab", [&]() { return AcceptChamber(); }}, // 20
        ...
        new Move_WaitAndContinue{-6622.24F, 10387.12F, "Go Basement 1"},
        ...
        new Move_WaitAndContinue{-8518.53F, 4765.09F, "Go Basement 5", cast_sq},
        new Move_CastSkillAndContinue{-8518.53F, 4765.09F, "Cast EoE 4", &skillbar.eoe}, // 30
        ...
        new Move_NoWaitAndContinue{-13760.19F, 358.15F, "Go Spirits 1"},
        new Move_DistanceAndContinue{-13872.34F, 2332.34F, "Go Spirits 2", 4900.0F}, // 40
        ...
        new Move_NoWaitAndStop{11368.55F, -17974.64F, "Talk Planes", talk_reaper_fn}, // 50
        ...
        new Move_NoWaitAndContinue{-9567.56F, 17288.916F, "Go To Dhuum 4"}, // 60
